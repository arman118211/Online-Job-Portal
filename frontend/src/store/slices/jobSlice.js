...
export const fetchJobs =
  ...
  async (dispatch) => {
    try {
      ...
      let link = `${import.meta.env.VITE_BASE_URL}/api/job/getall?`;
      let queryParams = [];
      if (searchKeyword) {
...
export const fetchSingleJob = (jobId) => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      `${import.meta.env.VITE_BASE_URL}/api/job/get/${jobId}`,
...
export const postJob = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      `${import.meta.env.VITE_BASE_URL}/api/job/post`,
      data,
...
export const getMyJobs = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      `${import.meta.env.VITE_BASE_URL}/api/job/getmyjobs`,
      { withCredentials: true }
    );
...
export const deleteJob = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `${import.meta.env.VITE_BASE_URL}/api/job/delete/${id}`,
      { withCredentials: true }
    );
